---
title: A ciência por trás da abertura de One Piece X As mulheres que estão à frente da Ciência da Computação                      # <- Altere o título
...
tags:
    - Participação feminina na computação # <- Altere para o tema do episódio. Se for igual ao de cima, remova essa linha
    - Presença e permanência de mulheres na tecnologia 
    - Os 3 tipos de escuta definidos por Michel Chion e Márcia Carvalho # <- Altere para o tema do vídeo
...
![Thumbnail](https://img.youtube.com/vi/22pyy26mqdQ/hqdefault.jpg)
