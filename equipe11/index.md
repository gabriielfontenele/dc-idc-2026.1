...
# Como funciona a geração de malhas adaptativas?
Durante a produção do nosso vídeo, fomos para a área de computação gráfica e aprofundamos o tema de geração e otimização de imagens, baseados no trabalho **"Geração de Malhas por Refinamento Adaptativo Usando GPU"** , do autor ***Ricardo Lenz***. O objetivo foi apresentar de forma mais aprofundada como funciona a técnica de suavização de malhas brutas e o potencial dessa tecnologia.  Detalhar como as placas de vídeo (GPUs) são programadas para processar essas malhas geométricas ajuda a entender o aumento significativo do realismo em aplicações de realidade virtual. Aproveitem o vídeo!